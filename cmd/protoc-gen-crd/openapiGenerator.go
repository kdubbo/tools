...
import (
	...
	"github.com/kdubbo/tools/cmd/protoc-gen-crd/pkg/protomodel"
)
...
func (g *openapiGenerator) generateFile(
		...
		for _, version := range versions {
			...
			if sr, f := cfg["subresource"]; f {
				...
				if k == "status" {
					if v == "" {
						// Back compat
						v = "dubbo.meta.v1alpha1.DubboStatus"
					}
	...
	bb := &bytes.Buffer{}
	bb.WriteString("# DO NOT EDIT - Generated by Cue OpenAPI generator based on Dubbo APIs.\n")
